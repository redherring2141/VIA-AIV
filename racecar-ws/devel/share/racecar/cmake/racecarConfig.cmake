...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'racecar' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/racecar-ws/src/racecar/racecar/${idir}'.  ${_report}")
    endif()
...
set(depends "tf;tf2_ros;urg_node;joy;joy_teleop;rosbag;rostopic;rviz;gmapping;hector_mapping;robot_pose_ekf")
