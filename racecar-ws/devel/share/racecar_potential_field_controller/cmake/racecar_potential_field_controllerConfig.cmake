...
if("TRUE" STREQUAL "TRUE")
  set(racecar_potential_field_controller_SOURCE_PREFIX /home/nvidia/racecar-ws/src/racecar-controllers/racecar_potential_field_controller)
  set(racecar_potential_field_controller_DEVEL_PREFIX /home/nvidia/racecar-ws/devel)
  ...
  set(racecar_potential_field_controller_INSTALL_PREFIX /home/nvidia/racecar-ws/install)
...
if(NOT "/home/nvidia/racecar-ws/devel/include;/home/nvidia/racecar-ws/src/racecar-controllers/racecar_potential_field_controller/include;/usr/include/eigen3 " STREQUAL " ")
  set(racecar_potential_field_controller_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/racecar-ws/devel/include;/home/nvidia/racecar-ws/src/racecar-controllers/racecar_potential_field_controller/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'racecar_potential_field_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/racecar-ws/src/racecar-controllers/racecar_potential_field_controller/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT racecar_potential_field_controller_NUM_DUMMY_TARGETS)
      set(racecar_potential_field_controller_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::racecar_potential_field_controller::wrapped-linker-option${racecar_potential_field_controller_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR racecar_potential_field_controller_NUM_DUMMY_TARGETS "${racecar_potential_field_controller_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::racecar_potential_field_controller::wrapped-linker-option${racecar_potential_field_controller_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND racecar_potential_field_controller_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/racecar-ws/devel/lib;/opt/ros/kinetic/lib)
